...
export default async function PrivacyPage() {
	...
	return (
		<div className="flex flex-col h-full">
			{/* Page header */}
			<div className="border-b border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900/80 px-6 py-4 shrink-0">
			...
			<div className="flex-1 overflow-y-auto p-6 print:p-8">
				<div className="max-w-3xl mx-auto space-y-10">
					{/* Introduction */}
					<section className="bg-zinc-50 dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-5">
					...
					<section>
						...
						<div className="space-y-4">
							{TRAFFIC_LIGHT.map((section) => (
								<div
									key={section.level}
									className={`rounded-lg border ${section.border} ${section.bg} p-5`}
								>
						...
						<div className="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 space-y-6">
							...
							<div>
								...
								<div className="flex flex-wrap items-center gap-2 text-sm">
									<div className="flex items-center gap-1.5 bg-zinc-50 dark:bg-zinc-700 border border-zinc-200 dark:border-zinc-600 rounded-lg px-3 py-2">
										<svg
					...
					{/* Print footer */}
					<div className="hidden print:block text-xs text-zinc-400 pt-4 border-t border-zinc-200">
						{t("printFooter")}
					</div>
				</div>
			</div>
